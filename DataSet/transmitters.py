...
from gnuradio.digital import constellation
import mapper
sps = 8
ebw = 0.35
...
class transmitter_mapper(gr.hier_block2):
    def __init__(self, modtype, symvals, txname, samples_per_symbol=2, excess_bw=0.35):
        ...
        gr.hier_block2.__init__(self, txname, gr.io_signature(1, 1, gr.sizeof_char), gr.io_signature(1, 1, gr.sizeof_gr_complex))
...
class transmitter_bpsk(transmitter_mapper):
    ...
    def __init__(self):
        transmitter_mapper.__init__(self, mapper.BPSK, [0, 1], "transmitter_bpsk", sps, ebw)
...
class transmitter_qpsk(transmitter_mapper):
    ...
    def __init__(self):
        transmitter_mapper.__init__(self, mapper.QPSK, [0, 1, 3, 2], "transmitter_qpsk", sps, ebw)
...
class transmitter_8psk(transmitter_mapper):
    ...
    def __init__(self):
        transmitter_mapper.__init__(self, mapper.PSK8, [0, 1, 3, 2, 7, 6, 4, 5], "transmitter_8psk", sps, ebw)
...
class transmitter_pam4(transmitter_mapper):
    ...
    def __init__(self):
        transmitter_mapper.__init__(self, mapper.PAM4, [0, 1, 3, 2], "transmitter_pam4", sps, ebw)
...
class transmitter_cpfsk(gr.hier_block2):
    ...
    def __init__(self):
        gr.hier_block2.__init__(self, "transmitter_cpfsk", gr.io_signature(1, 1, gr.sizeof_char), gr.io_signature(1, 1, gr.sizeof_gr_complex))
...
class transmitter_fm(gr.hier_block2):
    ...
    def __init__(self):
        gr.hier_block2.__init__(self, "transmitter_fm", gr.io_signature(1, 1, gr.sizeof_float), gr.io_signature(1, 1, gr.sizeof_gr_complex))
...
class transmitter_am(gr.hier_block2):
    ...
    def __init__(self):
        gr.hier_block2.__init__(self, "transmitter_am", gr.io_signature(1, 1, gr.sizeof_float), gr.io_signature(1, 1, gr.sizeof_gr_complex))
...
class transmitter_amssb(gr.hier_block2):
    ...
    def __init__(self):
        gr.hier_block2.__init__(self, "transmitter_amssb", gr.io_signature(1, 1, gr.sizeof_float), gr.io_signature(1, 1, gr.sizeof_gr_complex))
        self.rate = 44.1e3/200e3
        self.interp = filter.fractional_interpolator_ff(0.0, self.rate)
...
transmitters = {"discrete": [transmitter_bpsk, transmitter_qpsk, transmitter_8psk, transmitter_pam4, transmitter_qam16, transmitter_qam64, transmitter_gfsk, transmitter_cpfsk],
